...
pagina_webm_to_mp4::pagina_webm_to_mp4(wstring director)
{
    ...
    if (!drept_ex_1.loadFromFile(project_director+"/assets/Media/webm_to_mp4/dreptunghi_exit.png")) {
    ...
    if (!drept_ex_2.loadFromFile(project_director+"/assets/Media/webm_to_mp4/dreptunghi_exit_1.png")) {
    ...
    if (!sag_ex.loadFromFile(project_director+"/assets/Media/webm_to_mp4/sageata_exit.png")) {
    ...
    if (!drept_1.loadFromFile(project_director+"/assets/Media/webm_to_mp4/dreptunghi.png")) {
    ...
    if (!sag.loadFromFile(project_director+"/assets/Media/webm_to_mp4/sageata.png")) {
    ...
    if (!poz_rotatie[0].loadFromFile(project_director+"/assets/Media/webm_to_mp4/youtube.png")) {
        mesaj_eroare="Eroare la incarcare logo mp4_0!\n";
        eroare=true;
    }


    //incarcare logo MP4 1
    if (!poz_rotatie[1].loadFromFile(project_director+"/assets/Media/webm_to_mp4/mp4_1.png")) {
        mesaj_eroare="Eroare la incarcare logo mp4_1!\n";
        eroare=true;
    }


    //incarcare logo MP4 2
    if (!poz_rotatie[2].loadFromFile(project_director+"/assets/Media/webm_to_mp4/mp4_2.png")) {
        mesaj_eroare="Eroare la incarcare logo mp4_2!\n";
        eroare=true;
    }


    //incarcare logo MP4 3
    if (!poz_rotatie[3].loadFromFile(project_director+"/assets/Media/webm_to_mp4/mp4_3.png")) {
        mesaj_eroare="Eroare la incarcare logo mp4_3!\n";
        eroare=true;
    }


    //incarcare logo MP4 4
    if (!poz_rotatie[4].loadFromFile(project_director+"/assets/Media/webm_to_mp4/mp4_4.png")) {
        mesaj_eroare="Eroare la incarcare logo mp4_4!\n";
        eroare=true;
    }


    //incarcare logo MP4 5
    if (!poz_rotatie[5].loadFromFile(project_director+"/assets/Media/webm_to_mp4/mp4_5.png")) {
        mesaj_eroare="Eroare la incarcare logo mp4_5!\n";
        eroare=true;
    }


    //incarcare logo MP4 6
    if (!poz_rotatie[6].loadFromFile(project_director+"/assets/Media/webm_to_mp4/mp4_6.png")) {
        mesaj_eroare="Eroare la incarcare logo mp4_6!\n";
        eroare=true;
    }


    //incarcare logo MP4 7
    if (!poz_rotatie[7].loadFromFile(project_director+"/assets/Media/webm_to_mp4/mp4_7.png")) {
        mesaj_eroare="Eroare la incarcare logo mp4_7!\n";
        eroare=true;
    }


    //incarcare logo MP4 8
    if (!poz_rotatie[8].loadFromFile(project_director+"/assets/Media/webm_to_mp4/mp4_8.png")) {
        mesaj_eroare="Eroare la incarcare logo mp4_8!\n";
        eroare=true;
    }


    //incarcare dreptunghi convert albastru
    if (!sub_1.loadFromFile(project_director+"/assets/Media/webm_to_mp4/submit_1.png")) {
    ...
    if (!sub_2.loadFromFile(project_director+"/assets/Media/webm_to_mp4/submit_2.png")) {
    ...
    if (!ch_1.loadFromFile(project_director+"/assets/Media/webm_to_mp4/choose.png")) {
    ...
    if (!ch_2.loadFromFile(project_director+"/assets/Media/webm_to_mp4/choose_1.png")) {
    ...
    //incarcare fundal
    if (!background.loadFromFile(project_director+"/assets/Media/webm_to_mp4/background.png")) {
    ...
    if (!error_box_1.loadFromFile(project_director+"/assets/Media/webm_to_mp4/error_box_1.png")) {
    ...
    if (!error_box_2.loadFromFile(project_director+"/assets/Media/webm_to_mp4/error_box.png")) {
...
Sprite pagina_webm_to_mp4:: desenare(float width, float height, sf::Vector2i mousePos,const tgui::TextArea::Ptr& editBox1,const tgui::TextArea::Ptr& editBox2,Event event) {
...
//configurarea text box urilor
    ...
    editBox1->setDefaultText("Insert the \".webm\" file here...");
    ...
    draw_figura(renderTexture,text,drept_1,0,
                252,27,"     Convert\n"
                       "Webm to Mp4",83,252+180-36-9,27+36);

    //mesaj pentru text boxuri
     draw_text(renderTexture,text,"   Please enter the \".webm\" file in the box below\n"
                         "   (Introdu fisierul \".webm\" in caseta de mai jos)",29,252+72+18,225+54);


     draw_text(renderTexture,text,"Please enter the \".mp4\" file destination in the box below\n"
                   " (Introdu destinatia fisierului \".mp4\" in caseta de mai jos)",29,252+45,504);
        ...
        if(event.type == sf::Event::MouseButtonPressed && event.mouseButton.button == sf::Mouse::Left)
        {
            ...
            if (!operatie_in_progres) {
                ...
                std::thread convertThread([&]() {
                    ...
                    convert_x_to_y(id_text_box_1, id_text_box_2, editBox1, editBox2,L".webm",L".mp4");
...
//buton choose de la alegerea fisierului/directorului
    ...
    else
    {
        ...
        if(event.type == sf::Event::MouseButtonPressed && event.mouseButton.button == sf::Mouse::Left)
        {
            ...
            locatie_fisier = selecteazaFisier(".webm");
    ...
    if(operatie_in_progres||(poz_sag>7&&poz_sag+198<=507)||rotire)
    {
        draw_figura(renderTexture,text,sag,0,
                    1120, (float)180-18+ (float)poz_sag,"",0,0,0);
    ...
    //rotirea imaginii de MP4 in timpul convertirii (dreapta jos)
    if(rotire) {
        id_rotatie++;
...
void pagina_webm_to_mp4:: resetare_valori(const tgui::TextArea::Ptr& editBox1,const tgui::TextArea::Ptr& editBox2)
{
    id_insertie_invalida=false;
